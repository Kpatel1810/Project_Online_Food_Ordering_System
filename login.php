...
if(isset($_REQUEST['btn'])=="Send")
{
	...
	extract($_POST);
 	...
 	$l=mysql_query("select * from registration_table where email='$em'or contact_number='$mob' and password='$pwd'")or die ("QF");
		if(mysql_num_rows($l))
		{
			$data=mysql_fetch_array($l);
			$_SESSION['user']=$data['rid'];
